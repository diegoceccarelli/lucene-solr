...
public abstract class RankQuery extends ExtendedQueryBase {
  ...
  public abstract TopDocsCollector getTopDocsCollector(TopDocsCollector previousCollector, int length, Sort sort, IndexSearcher searcher) throws IOException;
